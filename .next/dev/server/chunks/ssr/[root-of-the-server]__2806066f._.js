...
function AuthProvider({ children }) {
    ...
    const [currentTeacher, setCurrentTeacher] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const login = (newRole, id)=>{
        setRole(newRole);
        if (newRole === "student") {
            const student = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummy$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STUDENTS"].find((s)=>s.id === id);
            setCurrentStudent(student || null);
            setCurrentTeacher(null);
        } else {
            const teacher = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummy$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TEACHERS"].find((t)=>t.id === id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2806066f._.js.map