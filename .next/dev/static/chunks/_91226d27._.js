...
function AuthProvider({ children }) {
    ...
    const [currentTeacher, setCurrentTeacher] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const login = (newRole, id)=>{
        setRole(newRole);
        if (newRole === "student") {
            const student = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummy$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STUDENTS"].find((s)=>s.id === id);
            setCurrentStudent(student || null);
            setCurrentTeacher(null);
        } else {
            const teacher = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummy$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEACHERS"].find((t)=>t.id === id);
...
_s(AuthProvider, "kvTxrh3wB9yfS2jwb/bux2wd/fE=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_91226d27._.js.map